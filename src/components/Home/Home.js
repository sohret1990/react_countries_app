...
import { ScrollView, View, Text, Button, Image, TextInput, TouchableOpacity } from 'react-native';
...
export default function Home() {
    ...
    return (
        ...
        <View style={{flex:1, margin: 8}}>
            ...
            <View style={{ borderWidth: 1, borderColor: 'blue', flexDirection: 'row', borderRadius: 8, marginBottom: 10 }}>
            ...
            <View style={{ borderWidth: 1, borderColor: 'lightgray', alignItems: 'center', justifyContent: 'center', borderRadius: 8, marginBottom: 10, backgroundColor: 'blue', padding: 10 }}>
            ...
            <ScrollView>
                {
                    countries.map(country => {
                        return (
                            ...
                            <TouchableOpacity key={'ContainerView' + country.flag} style={{ flex: 1, flexDirection: 'row', marginBottom: 10, borderWidth: 1, borderRadius: 8, backgroundColor: '#ddeefd', borderColor: 'lightblue', padding: 10 }}>
